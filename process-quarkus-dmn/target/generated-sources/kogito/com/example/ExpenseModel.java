...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "expense", name = "Expense", hidden = false)
public class ExpenseModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<ExpenseModelOutput> {
    ...
    @Override()
    public ExpenseModelOutput toModel() {
        ExpenseModelOutput result = new ExpenseModelOutput();
        result.setId(getId());
