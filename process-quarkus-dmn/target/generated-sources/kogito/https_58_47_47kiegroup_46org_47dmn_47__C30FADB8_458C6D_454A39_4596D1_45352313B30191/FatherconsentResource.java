 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__C30FADB8_458C6D_454A39_4596D1_45352313B30191;
...
@Path("/fatherconsent")
public class FatherconsentResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_C30FADB8-8C6D-4A39-96D1-352313B30191", "fatherconsent");
        org.kie.dmn.api.core.DMNResult decisionResult = decision.evaluateAll(DMNJSONUtils.ctx(decision, variables));
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_C30FADB8-8C6D-4A39-96D1-352313B30191", "fatherconsent", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("fatherconsent") + ".dmn_nologic")));
    }
